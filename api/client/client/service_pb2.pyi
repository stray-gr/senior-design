...
class SensorRows(_message.Message):
    ...
    rh: float
    epoch: int
    def __init__(self, entry_id: _Optional[int] = ..., facility_id: _Optional[int] = ..., device: _Optional[str] = ..., temp: _Optional[float] = ..., rh: _Optional[float] = ..., epoch: _Optional[int] = ...) -> None: ...
