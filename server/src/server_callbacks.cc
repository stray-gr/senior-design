...
namespace server {
    void callbacks::sensor_callback(std::mutex *io_mtx, std::vector<std::string> pb_vec, std::string tag) {
    ...
    void callbacks::lwt_callback(std::mutex *io_mtx, std::vector<std::string> pb_vec, std::string tag) {
